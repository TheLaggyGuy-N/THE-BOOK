...
class BerkasController {
    public function index() {
        ...
        $data = $model->tampilData($_SESSION['id_user'], $pencarian);
    ...
    public function penerima() {
        ...
        $model = new Berkas();
        $pencarian = trim($_GET['q'] ?? '');
        $data = $model->tampilDiterima($_SESSION['id_user'], $pencarian);
        foreach ($data as &$row) {
    ...
    public function tambah() {
        ...
        $model = new Berkas();
        $userModel = new User();
        if (!$userModel->dataPersonalLengkap($_SESSION['id_user'])) {
            $_SESSION['pesan'] = 'Lengkapi data personal di Profil sebelum mengirim berkas.';
    ...
    public function prosesTambah() {
        ...
        $model = new Berkas();
        $userModel = new User();
        if (!$userModel->dataPersonalLengkap($pengirim)) {
            $_SESSION['pesan'] = 'Lengkapi data personal di Profil sebelum mengirim berkas.';
            header("Location: index.php?aksi=profile");
            exit;
        }
