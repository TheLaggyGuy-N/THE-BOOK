...
class PasswordController {
    ...
    public function prosesGanti() {
        ...
        if (!$user || ($mode === 'ganti' && $passwordLama !== $user['password'])) {
            echo "Username Atau Email Anda Salah, Masukkan dengan benar! <a href='index.php?aksi=gantiPassword'>Kembali</a>";
            exit;
        }
        ...
        if ($model->gantiPassword($user['id_user'], $passwordBaru)) {
