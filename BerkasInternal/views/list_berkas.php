            ...
            <table>
                ...
                <?php foreach ($data as $row) { ?>
                    <tr class="recipient-row">
                        ...
                        <td>
                            <?php if ($row['belum_dapat_diterima']) { ?>
                        ...
                        <td>
                            ...
                            <?php if ($row['id_pengirim'] == $_SESSION['id_user']) { ?>
                                <a href="index.php?aksi=edit&id=<?php echo $row['id_berkas']; ?>">Edit</a>
                                <a href="index.php?aksi=hapus&id=<?php echo $row['id_berkas']; ?>"
                                    onclick="return confirm('Yakin ingin menghapus berkas ini?')">Hapus</a>
                            <?php } elseif ($row['tgl_terima'] === null) { ?>
                                <a href="index.php?aksi=terima&id=<?php echo $row['id_berkas']; ?>">Terima</a>
                            <?php } ?>
                        </td>
                    </tr>
